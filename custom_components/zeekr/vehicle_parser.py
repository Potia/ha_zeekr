...
class VehicleDataParser:
    ...
    def get_position_info(self) -> Dict[str, Any]:
        ...
        # Преобразуем координаты из целых чисел в градусы
        latitude = int(position.get('latitude', 0)) / 1e7
        longitude = int(position.get('longitude', 0)) / 1e7
    ...
    def get_movement_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'direction': int(basic.get('direction', 0)),
        }
